...
public interface CoreSession {
     ...
     * @since 11.1
     */
    String RETAIN_UNTIL_INDETERMINATE_ISO = "9999-01-01T00:00Z";

    /**
     * The special date that corresponds to a retention date in the indeterminate future.
     *
     * @see #setRetainUntil
     * @see #RETAIN_UNTIL_INDETERMINATE_ISO
     * @since 11.1
     */
    Calendar RETAIN_UNTIL_INDETERMINATE = GregorianCalendar.from(ZonedDateTime.parse(RETAIN_UNTIL_INDETERMINATE_ISO));
